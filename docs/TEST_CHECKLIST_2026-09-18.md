...
| # | ทำอะไร | ที่คาดหวัง |
|---|---|---|
| U.1 | เปิดหน้าเว็บ | แถบบน "ROC Simulator / By (SuperTon VIP:1269)" ไล่สีน้ำเงิน, หัวข้อเป็นฟอนต์ Prompt, ข้อความทั่วไป Sarabun, พื้นหลังฟ้าอ่อน การ์ดมุมมน |
| U.2 | เอาเมาส์ชี้ไอเทม/การ์ด | **ไม่มี** popup เด้งเอง |
| U.3 | คลิกที่ชื่อไอเทมในช่อง | popup รายละเอียด + ปุ่ม "เปลี่ยน" / "ถอด" ด้านล่าง (คำอธิบายยาวเลื่อนใน popup ได้ ปุ่มติดอยู่ล่าง) |
| U.4 | คลิกชิปการ์ด / ชิป enchant | popup รายละเอียดของการ์ด/enchant + "เปลี่ยน" / "ถอด" (ชิปว่างคลิกแล้วเปิด picker ทันทีเหมือนเดิม) |
| U.5 | ใน picker กดไอคอน ⓘ ท้ายแถว | แสดงรายละเอียดด้านขวา (ไม่เด้งตอนเมาส์ผ่าน) |
